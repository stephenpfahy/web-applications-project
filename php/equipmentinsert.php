...
$sql="INSERT INTO equipment (EQUIPMENT_ID, TYPE, DESCRIPTION, VALUE, INSPECTION_DATE, STATE_OF_REPAIR)
VALUES
('$_POST[EQUIPMENT_ID]','$_POST[TYPE]','$_POST[DESCRIPTION]','$_POST[VALUE]', '$_POST[INSPECTION_DATE]', '$_POST[STATE_OF_REPAIR]')";
